...
local plrs = GetService(game:GetService("Players"))
local cre = GetService(game:GetService("CoreGui"))
local rs = GetService(game:GetService("RunService"))
local ts = GetService(game:GetService("TweenService"))
local uis = GetService(game:GetService("UserInputService"))
local hs = GetService(game:GetService("HttpService"))
local ws = GetService(game:GetService("Workspace"))
